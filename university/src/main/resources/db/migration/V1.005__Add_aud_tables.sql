...
create table student_aud (id int4 not null, rev int4 not null, revtype int2, birthdate date, edu_id int4, name varchar(255), num_free_semesters int4, semester int4, primary key (id, rev));
